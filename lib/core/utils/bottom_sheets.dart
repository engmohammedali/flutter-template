...
///
/// The [children] parameter is a list of [Widget] objects that will be displayed in the bottom sheet.
///
/// The function returns a [Future] that completes with the result of dismissing the bottom sheet.
///
/// Example usage:
/// ```dart
/// showOptions([
